...
//hard coded vars
$employeeName = "Chyler Espino"; //employee name
$hoursWorked = 40.0; //hrs worked in week
$payRate = 54.50; //pay rate by hr 
$federalTaxRate = 0.245; //fed tax witholding rate
$stateTaxRate = 0.055; //state tax witholding rate
...
$annualPay = $grossPay * 52; //weeks in a year
